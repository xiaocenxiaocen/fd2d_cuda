...
__global__ static void pml2d_kernel(float * __restrict__ um, float * __restrict__ uo, float * __restrict__ vel, const int lda, const float dx, const float dz, pml2d_gpu_t * pmlxl, pml2d_gpu_t * pmlxr) 
{
	__shared__ float smem[STENCIL_Y][STENCIL_X];
